...
add_action('action_hook_espresso_template_calendar_table_update_api', 'espresso_template_calendar_table_load_pue_update');
function espresso_template_calendar_table_load_pue_update() {
